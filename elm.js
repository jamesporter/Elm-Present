...
var author$project$SlideShow$asHtml = function (content) {
	return A2(elm_explorations$markdown$Markdown$toHtml, _List_Nil, content);
};
var author$project$SlideShow$simple = function (md) {
...
var author$project$Present$animationSubs = function (presentation) {
	...
	if (_n0.$ === 'At') {
		...
		return _List_fromArray(
			[
				elm$browser$Browser$Events$onAnimationFrameDelta(author$project$Messages$TimeUpdate)
			]);
	}
};
...
var author$project$Present$subscriptions = function (presentation) {
	return elm$core$Platform$Sub$batch(
		_Utils_ap(
			_List_fromArray(
				[
					ohanhi$keyboard$Keyboard$downs(author$project$Messages$KeyDown)
				]),
			author$project$Present$animationSubs(presentation)));
};
var author$project$Models$Forward = F3(
	function (a, b, c) {
		return {$: 'Forward', a: a, b: b, c: c};
	});
	...
	switch (_n0.$) {
		...
		default:
			...
			return _Utils_update(
				presentation,
				{
					position: A3(author$project$Models$Forward, to, from, 1.0 - progress)
				});
	}
};
var author$project$Models$Backward = F3(
	function (a, b, c) {
	...
	switch (_n0.$) {
		...
		default:
			...
			return _Utils_update(
				presentation,
				{
					position: A3(author$project$Models$Backward, to, from, 1.0 - progress)
				});
	}
};
...
var author$project$Updates$keyDown = F2(
	function (key, presentation) {
		...
		switch (_n0) {
			...
			case 'ArrowRight':
				return author$project$Updates$next(presentation);
			case 'Escape':
				return _Utils_update(
					presentation,
					{
...
var author$project$Updates$timeUpdate = F2(
	function (time, presentation) {
		var ds = 2.0e-3 * time;
		var _n0 = presentation.position;
		switch (_n0.$) {
			case 'At':
			...
			case 'Forward':
				...
				var to = _n0.b;
				var progress = _n0.c;
				var newProgress = progress + ds;
				return (newProgress > 1.0) ? _Utils_update(
					presentation,
					{
						position: author$project$Models$At(to)
					}) : _Utils_update(
					presentation,
					{
						position: A3(author$project$Models$Forward, from, to, newProgress)
					});
			default:
				var from = _n0.a;
				var to = _n0.b;
				...
				return (newProgress > 1.0) ? _Utils_update(
					...
					presentation,
					{
						position: A3(author$project$Models$Backward, from, to, newProgress)
					});
		}
	});
	...
	function (msg, presentation) {
		switch (msg.$) {
			case 'TimeUpdate':
				var dt = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Updates$timeUpdate, dt, presentation),
					elm$core$Platform$Cmd$none);
			case 'KeyDown':
				var key = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Updates$keyDown, key, presentation),
					elm$core$Platform$Cmd$none);
			case 'Next':
				return _Utils_Tuple2(
...
var author$project$Models$cleanSlides = function (rawSlides) {
	return A2(
...
var author$project$Models$slides = function (pres) {
	var slds = pres.slides;
	var position = pres.position;
	switch (position.$) {
		case 'At':
			var n = position.a;
			var slide = A2(elm$core$Array$get, n, slds);
			return author$project$Models$cleanSlides(
				_List_fromArray(
					[
						_Utils_Tuple2(slide, 0.0)
					]));
		case 'Forward':
			var from = position.a;
			var to = position.b;
			...
			return author$project$Models$cleanSlides(
				_List_fromArray(
					[
						_Utils_Tuple2(
						A2(elm$core$Array$get, from, slds),
						-p),
						_Utils_Tuple2(
						A2(elm$core$Array$get, to, slds),
						1.0 - p)
					]));
		default:
			var from = position.a;
...
var author$project$Views$next = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$id('next'),
			elm$html$Html$Events$onClick(author$project$Messages$Next)
		]),
	_List_Nil);
var author$project$Messages$Previous = {$: 'Previous'};
var author$project$Views$prev = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			elm$html$Html$Attributes$id('prev'),
			elm$html$Html$Events$onClick(author$project$Messages$Previous)
		]),
	_List_Nil);
...
var author$project$Views$progressView = function (presentation) {
	var width = author$project$Views$widthSpec(
		author$project$Models$progress(presentation));
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Views$opacitySpec = function (amount) {
	return elm$core$String$fromFloat(
		1.0 - elm$core$Basics$abs(amount));
};
var author$project$Views$transformSpec = function (amount) {
	var translate = elm$core$String$fromFloat(amount * 100);
	var scale = elm$core$String$fromFloat(
		0.8 + (0.2 * (1.0 - elm$core$Basics$abs(amount))));
	return 'translate(' + (translate + ('vw, 0%) scale(' + (scale + ')')));
};
	...
	function (slide, position) {
		...
		var containerStyle = _List_fromArray(
			[
				...
				'transform',
				author$project$Views$transformSpec(position)),
				A2(
				elm$html$Html$Attributes$style,
				'opacity',
				author$project$Views$opacitySpec(position))
			]);
		return A2(
			elm$html$Html$div,
			_Utils_ap(
...
var author$project$Views$view = function (presentation) {
	var currentSlides = author$project$Models$slides(presentation);
	return {
				...
				_Utils_ap(
					A2(
						...
						function (_n0) {
							var s = _n0.a;
							var p = _n0.b;
							return A2(author$project$Views$viewSlide, s, p);
						},
						currentSlides),
					_List_fromArray(
						[
							author$project$Views$progressView(presentation),
							author$project$Views$prev,
							author$project$Views$next
						])))
			]),
		title: 'Present'
	};
...
var author$project$Present$main = elm$browser$Browser$document(
	{init: author$project$Present$init, subscriptions: author$project$Present$subscriptions, update: author$project$Updates$update, view: author$project$Views$view});
